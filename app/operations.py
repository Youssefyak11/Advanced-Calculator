...
def register_operation(name: str, func: Callable[[float, float], float]):
    _registry[name] = Operation(name, func)
...
# ✅ This is the list function you asked about
def list_operations() -> Dict[str, Operation]:
    """Return all registered operations as a dict, sorted by name."""
    return dict(sorted(_registry.items()))

# Register all your operations
register_operation("add", lambda a, b: a + b)
register_operation("subtract", lambda a, b: a - b)
register_operation("multiply", lambda a, b: a * b)
register_operation("divide", lambda a, b: a / b)
